...
class Gallery extends \AppBundle\Entity\Gallery implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Gallery' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Gallery' . "\0" . 'year', '' . "\0" . 'AppBundle\\Entity\\Gallery' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Gallery' . "\0" . 'href', '' . "\0" . 'AppBundle\\Entity\\Gallery' . "\0" . 'image', '' . "\0" . 'AppBundle\\Entity\\Gallery' . "\0" . 'imageFile');
        }
